...
cmd(_0x1a49cf, async (_0x25f23f, _0xbb18b2, _0x45e8b7, {
  ...
  try {
    ...
    let _0x42218a = "👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗  𝗚𝗢𝗦𝗜𝗣𝗟𝗔𝗡𝗞𝗔👨‍💻\n\n*📚 Title:* " + _0x58f282 + "\n*🔖 Link:* " + _0x5f1e4a + "\n*🕛 Date:* " + _0x3ebfc0 + "\n*📃 Description:* " + _0x5b0d6f;
    const _0x56ae31 = {
      url: _0x5e3008
    };
    const _0x3d27d7 = {
...
cmd(_0x1ce464, async (_0x610eff, _0x262cc1, _0x52e34a, {
  ...
  try {
    ...
    let _0x85054b = "👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗  𝗟𝗔𝗡𝗞𝗔𝗧𝗥𝗨𝗧𝗛👨‍💻\n\n*📚 Title:* " + _0x1b0831 + "\n*🔖 Link:* " + _0x440901 + "\n*🕛 Date:* " + _0x23d7c7 + "\n*📃 Description:* " + _0x29b2f3;
    const _0x557f12 = {
      url: _0x386f88
    };
    const _0xfa9ebc = {
...
cmd(_0x492eec, async (_0x2ceaf1, _0x5adb7a, _0x4c4f0b, {
  ...
  try {
    ...
    let _0x5c4bd5 = "👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 𝗦𝗜𝗟𝗨𝗠𝗜𝗡𝗔👨‍💻\n\n*📚 Title:* " + _0x28d77a + "\n*🔖 Link:* " + _0x220a9e + "\n*🕛 Date:* " + _0x34675c + "\n*📃 Description:* " + _0x425257;
    const _0x3c3c97 = {
      url: _0x263c3e
    };
    const _0x58df41 = {
...
cmd(_0x2d56a3, async (_0x3cb8d6, _0x1e2d8f, _0x54fe33, {
  ...
  try {
    ...
    const _0x3240e8 = {
      caption: "🎬 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 LYRICS 🎬",
      image: _0x5e7e1e,
      footer: "LYRICS SEARCH BY 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗",
...
cmd(_0x4fb1ba, async (_0x1c08a8, _0x32d50d, _0x389844, {
  ...
  try {
    ...
    let _0x53c61e = "👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 𝗟𝗬𝗥𝗜𝗖𝗦 𝗦𝗘𝗔𝗥𝗖𝗛👨‍💻\n\n*📚 TITLE:* " + _0x113eb0 + '|' + _0x363e2e + "\n*🔖 ARTIST:* " + _0x22b200 + "\n*⛓️ LYRICS:* " + _0x5549f4;
    const _0x107950 = {
      url: _0x38bb67
    };
    const _0x498f0e = {
