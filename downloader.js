...
cmd(_0xae8192, async (_0x47213b, _0x3f37ba, _0x1bf74f, {
  ...
  try {
    ...
    if (config.MODE === "nonbutton") {
      ...
      const _0x41557e = {
        caption: "🎬 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 PASTPAPER-DL 🎬",
        image: _0x3bffd1,
        footer: config.FOOTER,
...
cmd(_0x13ee25, async (_0x4b759a, _0x1a5cca, _0x3be992, {
  ...
  try {
    ...
    if (config.MODE === "nonbutton") {
      ...
      const _0x25aaaa = {
        caption: "⚜️ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 MODWHATSAPP-DL ⚜️",
        image: _0x5a814a,
        footer: config.FOOTER,
    ...
    if (config.MODE === "button") {
      ...
      const _0x60d5ff = {
        ...
        header: '',
        footer: config.FOOTER,
        body: "⚜️ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 MODWHATSAPP-DL ⚜️"
      };
      const _0x5ac495 = {
        quoted: _0x3be992
      };
...
cmd(_0xb1bbf2, async (_0x8fcdc1, _0x1c1908, _0x2e6ab8, {
  ...
  try {
    ...
    const _0x4c7d82 = "⚜️ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 MODWHATSAPP-DL ⚜️\n\n🚀 Title :- " + _0x51b794 + "\n📄 Date :- " + _0x20f7f6;
    if (config.MODE === "nonbutton") {
      const _0x54df37 = {
        quoted: _0x2e6ab8
      };
...
cmd(_0x72b40b, async (_0xf3adc0, _0x3bedfe, _0x1b759d, {
  ...
  try {
    ...
    if (config.MODE === "nonbutton") {
      ...
      const _0x458684 = {
        text: "⚜️ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 MODWHATSAPP-DL ⚜️",
        footer: config.FOOTER,
        title: "Result from Mod Whatsapp. 📲",
        buttonText: "*🔢 Reply below number*",
        sections: _0x42d508
...
cmd(_0x4f4b82, async (_0x247cfc, _0x5d35f1, _0x3a8e35, {
  ...
  try {
    ...
    if (config.MODE === "nonbutton") {
      ...
      const _0x373560 = {
        caption: "🔱 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 MODAPK-DL 🔱",
        image: _0x1841a5,
        footer: config.FOOTER,
    ...
    if (config.MODE === "button") {
      ...
      const _0x541907 = {
        ...
        header: '',
        footer: config.FOOTER,
        body: "⚜️ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 MODAPK-DL ⚜️"
      };
      const _0x2e1651 = {
        quoted: _0x3a8e35
      };
  ...
  try {
    ...
    if (config.MODE === "button") {
      ...
      const _0x3a4164 = {
        ...
        header: '',
        footer: config.FOOTER,
        body: "⚜️ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 MODGAME-DL ⚜️"
      };
      const _0x40e2d1 = {
        quoted: _0xc8f656
      };
...
cmd(_0x19275c, async (_0x2f8e8e, _0x10527c, _0x3c5854, {
  ...
  try {
    ...
    let _0x566335 = "[👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 👨‍💻]\n   \n *MOD GAMES-DOWNLOADER*\n\n *📚 Title: " + _0xf90514 + "*\n *📈 Date: " + _0x124e15 + "*\n *♓ Category: " + _0x4f577b + "*\n *🧬 Vertion: " + _0xeba58c + "*\n *🌐 Mod Info: " + _0x4470f3 + "*\n \n─────────────────────────────";
    if (config.MODE === "nonbutton") {
      const _0x139eae = [{
        'title': '',
        'rows': [{
...
cmd(_0x52c7de, async (_0x37ebc8, _0x51219a, _0x4721a0, {
  ...
  try {
    ...
    let _0x176b4a = "[👨‍💻𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 👨‍💻]\n   \n *MOD APK-DOWNLOADER*\n\n *📚 ᴀᴘᴘ ɴᴀᴍᴇ: " + _0x102829 + "*\n *📈 ᴀᴘᴘ ꜱɪᴢᴇ: " + _0x3a42bc + "*\n *🧬 ᴀᴘᴘ ᴠᴇʀꜱɪᴏɴ: " + _0x176a89 + "*\n *🌐 ᴀᴘᴘ ᴏꜱ: " + _0x44cbc1 + "*\n \n─────────────────────────────";
    if (config.MODE === "nonbutton") {
      const _0x2b9146 = [{
        'title': '',
        'rows': [{
  ...
  try {
    ...
    if (config.MODE === "button") {
      ...
      const _0xd1a02c = {
        ...
        header: '',
        footer: config.FOOTER,
        body: "⚜️ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 XNXX-DL ⚜️"
      };
      const _0x57e5e8 = {
        quoted: _0x5d0676
      };
...
cmd(_0x29dead, async (_0x27e96a, _0x304c0b, _0x19e73d, {
  ...
  try {
    let _0x766adb = "[𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 👨‍💻]\n   \n ▏ *IMG-DOWNLOADER*\n\n ▏ *🎭 ʀᴇǫᴜᴇꜱᴛᴇʀ: " + _0x4e263c + "*\n ▏ *✏️ ʀᴇꜱᴜʟᴛ: " + _0x2f47ed + "*\n\n└──────◉";
    if (config.MODE === "nonbutton") {
      const _0x2f3ef0 = [{
        'title': '',
        'rows': [{
  ...
  try {
    ...
    _0x448e74(_0x456322, async (_0x416645, _0x3971cc) => {
      ...
      for (let _0x30edd2 = 0; _0x30edd2 < _0x22b0b5.length; _0x30edd2++) {
        ...
        let _0x5e3429 = {
          'image': _0x3735f5,
          'caption': "*-------「 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 GIMAGE SEARCH 」-------*\n🤠 *Query* : " + _0x456322 + "\n\n🔗 *Image " + (_0x30edd2 + 1) + " Url* : " + _0x2133c5
        };
        const _0x370213 = {
          quoted: _0x4e5cf6
        };
          ...
          'interactiveMessage': {
            ...
            'contextInfo': {
              ...
              'forwardedNewsletterMessageInfo': {
                ...
                'newsletterName': "⛅ 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 💙",
...
cmd(_0x55918a, async (_0x59a027, _0x152159, _0x4d8add, {
  ...
  try {
    ...
    const _0x960ca2 = {
      ...
      footer: "*ᴀʀɪʏᴀꜱ-ᴘᴏᴅɪʏᴀ-ᴍᴅ•ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴛᴇᴄʜɴɪᴄᴀʟ ᴄʏʙᴇʀꜱ*",
      buttons: _0x192c11,
      headerType: 0x1
    };
...
cmd(_0x1939e5, async (_0x49df3b, _0x4f7518, _0x4011d6, {
  ...
  try {
    ...
    _0x577ae2("*📥 𝙐𝙋𝙇𝙊𝘼𝘿𝙀𝘿 𝘽𝙔 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 𝙊𝙒𝙉𝙀𝙍*");
    _0x4f406b(_0x10c944);
  }
});
const _0x3b112c = {
...
cmd(_0x5bc7a1, async (_0x281e95, _0x44ecc6, _0x43bbc8, {
  ...
  try {
    ...
    _0xd2f7b1("*PODIYA MEDIAFIRE FILE DOWNLOADING...📥*");
    const _0xb486d8 = {
      url: _0x361d79
    };
    const _0x514571 = {
...
cmd(_0x38f92e, async (_0xe099a0, _0x3c2fef, _0x1d6693, {
  ...
  try {
    ...
    let _0x38b47a = "[👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗👨‍💻]\n\n*TIKTOK DOWNLOADER*\n\n*📃 Title:* " + _0x1772f7.result.title + "\n*✍🏼 Link:* " + _0x1c7532;
    if (config.MODE === "nonbutton") {
      const _0x38fe3e = {
...
cmd(_0x229a4f, async (_0x27b2e5, _0xd39606, _0x5ece28, {
  ...
  try {
    ...
    _0x6f5257.contextInfo.externalAdReply.title = "👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗👨‍💻";
...
cmd(_0xa30716, async (_0x30380c, _0x19e6e2, _0x34f972, {
  ...
  try {
    ...
    let _0x52955c = "PODIYA MD FB DOWNLOADER\n\n   \n*URL :* " + _0x4abeb3;
    if (config.MODE === "nonbutton") {
      var _0x364908 = [{
        'title': "SD TYPE 🪫",
        'rows': [{
