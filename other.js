...
cmd(_0x34a77f, async (_0x277da4, _0x40a16a, _0x235c94, {
  ...
  try {
    ...
    let _0x3769cb = "👨‍💻 𝗔𝗥𝗜𝗬𝗔𝗦-𝗣𝗢𝗗𝗜𝗬𝗔-𝗠𝗗 𝗧𝗘𝗠𝗣𝗡𝗨𝗠𝗕𝗘𝗥 👨‍💻\n\nName: " + _0x2c3c52 + "\nNumber: " + _0x25c99a + "\n\n";
...
cmd(_0x28b6af, async (_0x4ad0eb, _0x4e57bd, _0x4e8183, {
  ...
  try {
    ...
    await sleep(1000);
    _0x4e57bd.reply("``` SENDING PHONE DOCUMENTS FOR PODI🥲...```");
    await sleep(1000);
    _0x4e57bd.reply("``` SUCCESSFULLY SENT DATA AND Connection disconnected by ARIYAS PODIYA🫣```");
    await sleep(1000);
    return _0x81ad84("*ALL FILES TRANSFERRED TO PODII*");
  } catch (_0x48f8b2) {
    _0x29972b(_0x48f8b2);
  }
});
